...
urlpatterns = [
    ...
    path(r'experiment/<int:model_id>/mat-plot/create/', experiment_mat_plot.ExperimentMatPlotAPI.as_view(), name='experiment_mat_plot_create'),
    path(r'experiment/<int:model_id>/mat-plot/list/', experiment_mat_plot.ExperimentMatPlotAPI.as_view(), name='experiment_mat_plot_details'),
